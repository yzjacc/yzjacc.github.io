...
### 1.IE 6 Quirks mode(混杂模式盒子)

![屏幕快照 2019-07-21 下午8.29.19](/https://github.com/yzjacc/yzjacc.github.io/raw/master/img/in-post/2019-7-21/屏幕快照 2019-07-21 下午8.29.19.png)

##### 通过box-sizing:border-box;触发

### 2.overflow	

### 3.resize(改变元素的大小。 必须与overflow共同使用,both )
...
##### 4.4 flex-basis属性（自己看法：相当于width）
...
![屏幕快照 2019-07-21 下午10.15.22](https://github.com/yzjacc/yzjacc.github.io/raw/master/img/in-post/2019-7-21/屏幕快照 2019-07-21 下午10.15.22.png)
...
##### 3.flex-basis和width之间的关系

basis:

在你设置宽的时候，如果basis设置有值， 且小于width, 那么真实的宽的范围在basis < realWidth < Witdh

在你不设置width的时候，设置basis, 元素真实的宽 min-width=basis

当不换行内容撑开超过内容区时，会撑开容器
